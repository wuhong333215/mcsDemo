...
<body>
<form action="integ" method="post" class="bootstrap-frm">
	<h1>综合数据接口</h1>
	<label>
         <span><span style="color:red;">*</span>交易码:</span>
         <input type="text" name="tranCd" value="MC0010">
    </label>
    <label>
    ...
    <label>
    	<span><span style="color:red;">*</span>收款人账户:</span>
        <input type="text" name="actNo" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>收款人姓名:</span>
        <input type="text" name="actNm" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>账号类型:</span>
        <input type="text" name="actTyp" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>扣款身份证:</span>
        <input type="text" name="idCardNo" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>扣款手机号:</span>
        <input type="text" name="phoneNo" value="">
    </label>
    <label>
    	<span>联行行号:</span>
        <input type="text" name="lbnkNo" value="">
    </label>
    <label>
    	<span>支行信息:</span>
        <input type="text" name="lbnkNm" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>行别编码:</span>
        <input type="text" name="bnkCd" value="">
    </label>
    <label>
    	<span>开户行省:</span>
        <input type="text" name="proNm" value="">
    </label>
    <label>
    	<span>开户行市:</span>
        <input type="text" name="cityNm" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>放款金额:</span>
        <input type="text" name="loanAmt" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>放款利率:</span>
        <input type="text" name="loanRate" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>回款利息:</span>
        <input type="text" name="repayInt" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>回款期数:</span>
        <input type="text" name="payNo" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>还款周期:</span>
        <input type="text" name="repayPer" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>还款类型:</span>
        <input type="text" name="repayTyp" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>还款方式:</span>
        <input type="text" name="repayMod" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>计息方式:</span>
        <input type="text" name="intTyp" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>协议放款日期:</span>
        <input type="text" name="argLoanDt" value="">
    </label>
    <label>
    	<span><span style="color:red;">*</span>贷款终止日期:</span>
        <input type="text" name="argRepayDt" value="">
    </label>
    <label>
    	<span>通知地址:</span>
        <input type="text" name="noticeUrl" value="">
    </label>
    <label>
    	<span>备注:</span>
        <input type="text" name="rmk" value="">
